    ...
    return (
      <div className="min-h-screen bg-[#09090B] flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-[#A1A1AA] text-sm mb-6">This reset link is missing a token.</p>
          <Link to="/forgot-password" className="text-[#7C3AED] hover:text-[#A855F7] text-sm font-medium transition-colors">
            Request a new link →
          </Link>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-[#09090B] flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-[#A1A1AA] text-sm mb-6">Redirecting to sign in…</p>
          <Link to="/login" className="text-[#7C3AED] hover:text-[#A855F7] text-sm font-medium transition-colors">
            Sign in now →
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#09090B] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#18181B] border border-[#27272A] rounded-2xl p-8 shadow-xl">
          ...
          <p className="text-[#71717A] text-sm mb-6">Choose a strong password for your account.</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="reset-password" className="block text-sm font-medium text-[#A1A1AA] mb-1.5">
                New password
              </label>
              <input
                id="reset-password"
            ...
            <div>
              <label htmlFor="reset-confirm" className="block text-sm font-medium text-[#A1A1AA] mb-1.5">
                Confirm password
              </label>
              <input
                id="reset-confirm"
